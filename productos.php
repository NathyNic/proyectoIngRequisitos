    ...
    <div class="col-1-of-4">
      <div>
        ...
        <div class="category_list">
          ...
          <a href="#" class="category_item centrar" category="Tablet">Tablet</a>
        </div>
    ...
    <div class="col-3-of-4">
      ...
      <div id="lista-productos">
        ...
        <div class="product-layout card-deck mb-3 text-center">
          ...
          <?php
          include("con_db.php");
          $query = mysqli_query($conex, "SELECT id, linkImagen1, nombre, precio, tipo FROM productoshardware WHERE stock > 0;");
          ...
          ?>
                ...
                <div class="card mb-4 shadow-sm" category="<?php echo $data['tipo']; ?>">
                  <div class="card-header">
                    <a id="prod" href="<?php echo 'detallesproducto.php?id=' . $data['id'] ?>">
                      <h4 class="my-0 font-weight-bold"><?php echo $data['nombre'] ?></h4>
                    </a>
                  </div>
                  <div class="card-body">
                    <a id="prod" href="<?php echo 'detallesproducto.php?id=' . $data['id'] ?>" target="_blank"><?php echo '<img src="' . $data['linkImagen1'] . '" class="card-img-top"/>' ?></a>
                    <h1 class="card-title pricing-card-title ">$ <span class=""><?php echo $data['precio'] ?></span></h1>
                    <a href="cart.php?id=<?php echo $data['id']; ?>"><button class="btn" type="submit">Comprar</button></a>
                  </div>
                </div>
              <?php
              }
