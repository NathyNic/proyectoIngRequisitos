...
ob_start();
$id = $_GET['id'];
$query = mysqli_query($conex, "SELECT id, linkImagen1, nombre, precio, tipo, stock, descripcion FROM productoshardware WHERE id = $id;");
...
<section class="section product-detail">
    <div class="details container">
        ...
        <div class="right">
            ...
            <div class="price" data-id="<?php echo $dataProduct['id'] ?>"><?php echo '$' . $dataProduct['precio'] ?></div>
            ...
            <a href="cart.php?id=<?php echo $dataProduct['id']; ?>"><button class="btn" type="submit">Comprar</button></a>
            <!--<?php
                /*
